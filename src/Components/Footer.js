    ...
    <div className="footer-section">
      <div className="footer-container">
        <div className="ft-info">
          <div className="ft-info-p1">
            <p className="ft-title">
              Holistic <span className="ft-sign">+</span>
            </p>
            <p className="ft-description">
              Your personalized wellness companion — offering disease-specific
              guidance, natural remedies, ayurvedic suggestions, and yoga-based
              fitness, all in one green-friendly app.
            </p>
          </div>
        ...
        <div className="ft-list">
          <p className="ft-list-title">Solutions</p>
          <ul className="ft-list-items">
            <li>
              <a href="#services">Disease Precautions</a>
            </li>
            <li>
              <a href="#services">Diet & Nutrition Plans</a>
            </li>
            <li>
              <a href="#services">Yoga & Exercises</a>
            </li>
            <li>
              <a href="#services">Ayurvedic Remedies</a>
            </li>
            <li>
              <a href="#services">HealthBot Assistant</a>
            </li>
          </ul>
        </div>
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="mailto:support@holisticplus.com">support@holisticplus.com</a>
            </li>
            <li>
              <a href="mailto:health@holisticplus.com">health@holisticplus.com</a>
            </li>
            <li>
              <a href="tel:+91 8000819137">+91 8000819137</a>
            </li>
            <li>
      ...
      <div className="ft-copyright">
        <p>© 2025 Holistic+. All rights reserved.</p>

        <ul className="ft-social-links">
          <li>
            <a
              href="https://www.linkedin.com/in/shekhar-prajapat-92576a210/"
              title="LinkedIn"
              target="_blank"
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
                <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 
                  ...
                  54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2
                  -48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3
                  c12.4-23.5 42.69-48.3 87.88-48.3 
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 320 512">
                <path d="M279.14 288l14.22-92.66h-88.91v-60.13
                  c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 
          ...
          <li>
            <a
              href="https://x.com/Shekhar02635762"
              title="Twitter"
              target="_blank"
              rel="noopener noreferrer"
            >
