...
function AppointmentForm() {
  ...
  const handleSubmit = (e) => {
    ...
    if (preferredMode === "default") {
      errors.preferredMode = "Please select a communication mode";
    }
  ...
  return (
    <div className="appointment-form-section">
      <h1 className="legal-siteTitle">
        <Link to="/">
          Holistic <span className="legal-siteSign">+</span>
        </Link>
      </h1>
        ...
        <form className="form-content" onSubmit={handleSubmit} noValidate>
          ...
          {isSubmitted && (
            <p className="success-message">
              Appointment details have been sent to your phone via SMS.
            </p>
          )}
        </form>
      </div>
      ...
      <div className="legal-footer">
        <p>© 2013–2025 Holistic+. All rights reserved.</p>
      </div>
